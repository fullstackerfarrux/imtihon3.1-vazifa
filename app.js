...
btnCheese.addEventListener("click", () => {
  ...
  img.setAttribute("src", "../burger-layers/cheese.svg");
  a += 80;
  b += 1;
  e += 1;
  c += 80;
...
btnMeat.addEventListener("click", () => {
  ...
  let ingradients = document.querySelector(".ingradients");
  ingradients.prepend(img);
  img.setAttribute("src", "../burger-layers/meat.svg");
  a += 60;
  b += 1;
  e += 1;
  c += 60;
...
btnOnion.addEventListener("click", () => {
  ...
  let ingradients = document.querySelector(".ingradients");
  ingradients.prepend(img);
  img.setAttribute("src", "../burger-layers/onion.svg");
  a += 80;
  b += 1;
  e += 1;
  c += 80;
...
btnSalad.addEventListener("click", () => {
  ...
  let ingradients = document.querySelector(".ingradients");
  ingradients.prepend(img);
  img.setAttribute("src", "../burger-layers/salad.svg");
  a += 40;
  b += 1;
  e += 1;
  c += 40;
...
btnTomato.addEventListener("click", () => {
  ...
  let ingradients = document.querySelector(".ingradients");
  ingradients.prepend(img);
  img.setAttribute("src", "../burger-layers/tomato.svg");
  a += 50;
  b += 1;
  e += 1;
  c += 50;
...
btnPickle.addEventListener("click", () => {
  ...
  let ingradients = document.querySelector(".ingradients");
  ingradients.prepend(img);
  img.setAttribute("src", "../burger-layers/pickle.svg");
  a += 40;
  b += 1;
  e += 1;
  c += 40;
